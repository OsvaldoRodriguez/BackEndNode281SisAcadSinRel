...
export default {
  ...
  async mostrar(req, res) {
    try {
      const data = await models.Actividad_Evento_Solicita_Ambiente.findAll({
        // include : {
  ...
  async actualizar(req, res) {
    ...
    try {
      const data = await models.Actividad_Evento_Solicita_Ambiente.update(req.body, {
        where: {
          id: ID,
        },
      });
  ...
  async  eliminar(req, res) {
    ...
    try {
      const data = await models.Actividad_Evento_Solicita_Ambiente.destroy({
        where: {
          id: ID,
        },
      });
