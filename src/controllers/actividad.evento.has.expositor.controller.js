...
export default {
  ...
  async  guardar(req, res) {
    try {
      ...
      const data = await models.Actividad_Evento_Has_Expositor.create(req.body);
  ...
  async actualizar(req, res) {
    ...
    try {
      const data = await models.Actividad_Evento_Has_Expositor.update(req.body, {
        where: {
          id: ID,
        },
      });
  ...
  async  eliminar(req, res) {
    ...
    try {
      const data = await models.Actividad_Evento_Has_Expositor.destroy({
        where: {
          id: ID,
        },
      });
