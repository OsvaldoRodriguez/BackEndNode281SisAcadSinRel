  ...
  class Usuario extends Model {
    ...
    static associate(models) {
      ...
      models.Usuario.belongsToMany(models.Evento, {
        through: models.Usuario_Se_Inscribe_Evento,
        foreignKey: 'UsuarioId'
      });
      models.Usuario.belongsToMany(models.Evento, {
        through: models.Usuario_Califica_Evento,
        foreignKey: 'UsuarioId'
      });
      models.Usuario.belongsToMany(models.Evento, {
        through: models.Usuario_Reserva_Participacion_Evento,
        foreignKey: 'UsuarioId'
      });
      models.Usuario.belongsToMany(models.Evento, {
        through: models.Usuario_Comenta_Evento,
        foreignKey: 'UsuarioId'
      });
      models.Usuario.belongsToMany(models.Actividad_Evento, {
        through: models.Usuario_Comenta_Actividad_Evento,
        foreignKey: 'UsuarioId'
      });
      models.Usuario.belongsToMany(models.Actividad_Evento, {
        through: models.Usuario_Asiste_Actividad_Evento,
        foreignKey: 'UsuarioId'
      });
    }
  }
