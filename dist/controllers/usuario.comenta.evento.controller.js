...
var _default = {
  async mostrar(req, res) {
    try {
      const data = await _models.default.Usuario_Comenta_Evento.findAll({
        // include : {
  ...
  async guardar(req, res) {
    try {
      ...
      const data = await _models.default.Usuario_Comenta_Evento.create(req.body);
  ...
  async actualizar(req, res) {
    ...
    try {
      const data = await _models.default.Usuario_Comenta_Evento.update(req.body, {
        where: {
          id: ID
        }
      });
  ...
  async eliminar(req, res) {
    ...
    try {
      const data = await _models.default.Usuario_Comenta_Evento.destroy({
        where: {
          id: ID
        }
      });
