...
var _default = {
  async mostrar(req, res) {
    try {
      const data = await _models.default.Actividad_Evento_Solicita_Ambiente.findAll({
        // include : {
  ...
  async guardar(req, res) {
    try {
      ...
      const data = await _models.default.Actividad_Evento_Solicita_Ambiente.create(req.body);
  ...
  async actualizar(req, res) {
    ...
    try {
      const data = await _models.default.Actividad_Evento_Solicita_Ambiente.update(req.body, {
        where: {
          id: ID
        }
      });
  ...
  async eliminar(req, res) {
    ...
    try {
      const data = await _models.default.Actividad_Evento_Solicita_Ambiente.destroy({
        where: {
          id: ID
        }
      });
